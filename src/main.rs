...
enum Command {
    ...
    /// Copy up to 126 explicit PNG assets and their metadata from assets.zip.
    Export {
        #[arg(long)]
        archive: PathBuf,
    ...
    /// Build an F6 toggle for locally generated Adeline seasonal, beach, and wedding portraits.
    PackageToggle {
        #[arg(long)]
        original: PathBuf,
        #[arg(long)]
