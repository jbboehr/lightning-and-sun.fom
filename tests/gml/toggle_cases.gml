...
assert(global.menu.portrait.index == 0.75);
global.menu.set_speaker({sprite: 230, index: 1.25});
assert(global.menu.portrait.sprite == 250);
assert(global.menu.portrait.index == 1.25);
...
assert(global.menu.portrait.index == 1.5);
global.menu.set_speaker({sprite: 230, index: 0.75});
assert(global.menu.portrait.sprite == 230);
assert(global.menu.portrait.index == 0.75);
