...
Taliferro's 36, Vera's 32, and Wheedle's 32 portrait strips, each with four
recolors: 7,568 generated variant strips. All twenty-nine characters start on
...
own saves and state in `tmp/vera-wheedle-playtest`, mounting the supplied
...
- F7 opens the portrait trial on Vera and advances expressions; Page Up goes backward.
...
`nix build --impure --file tmp/vera-wheedle-playtest-launch.nix --out-link tmp/play-characters`.

The Vera/Wheedle package passed a fresh isolated MOMI installation, but the
mounted game folder was empty during this slice. The launcher was rebuilt;
native gameplay remains untested. The [offline review pages](../../../generated/vera-wheedle-preview/blue-review/index.html)
cover every included Vera/Wheedle portrait expression and frame without the game.
...
Terithia, Stillwell, Taliferro, Vera, and Wheedle cycle spring, summer, autumn, and winter.
